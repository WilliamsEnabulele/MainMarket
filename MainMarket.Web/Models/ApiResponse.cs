...
public class ApiResponse<T>
{
    ...
    public ApiResponse(bool succeeded, T data, IEnumerable<string>? errors = null)
    {
        Succeeded = succeeded;
        Data = data;
        Errors = errors;
    ...
    public ApiResponse(bool succeeded, T data, IDictionary<string, string[]>? validationErrors = null)
    {
        Succeeded = succeeded;
        StatusCode = 200;
        Data = data;
